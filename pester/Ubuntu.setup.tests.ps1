...
<#
Set-Location /home/student/labFiles/pester/
$config=New-PesterConfiguration
$config.Output.Verbosity='detailed'
$config.Run.Path='/home/student/labFiles/pester/Ubuntu.Setup.tests.ps1'
...
Describe 'Lab Setup tests for 507Ubuntu VM' {
    ...
    Context 'Config files for labs' {
        It 'Custodian IAM yaml file exists' {
            '/home/student/labFiles/custodian/aws_iam.yaml' | Should -Exist
            '/home/student/labFiles/custodian/aws_iam.yaml' | Should -FileContentMatch 'iam-no-mfa'
            '/home/student/labFiles/custodian/aws_iam.yaml' | Should -FileContentMatch 'iam-inline-policy'
        }
        It 'Custodian Ingress yaml file exists' {
            '/home/student/labFiles/custodian/aws_ingress.yaml' | Should -Exist
            '/home/student/labFiles/custodian/aws_ingress.yaml' | 
                Should -FileContentMatch 'aws-ingress-admin-ports-allowed'
        }

        It 'Terraform main.tf file exists' {
            '/home/student/labFiles/infrastructure/terraform/aws/modules/storage/main.tf' | Should -Exist
            '/home/student/labFiles/infrastructure/terraform/aws/modules/storage/main.tf' |             
                Should -FileContentMatch 'aws_db_instance'
        }

        It 'Cloudquery.io aws.yml file exists' {
            '/home/student/labFiles/cloudquery.io/config/aws.yml'
            '/home/student/labFiles/cloudquery.io/config/aws.yml' |             
